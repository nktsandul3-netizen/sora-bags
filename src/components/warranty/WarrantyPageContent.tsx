    ...
    const c = locale === "ro"
      ? {
          ...
          warrantyText: [
            ...
            "Termenul de garanție începe să curgă din ziua predării produsului cumpărătorului.",
            "Dacă observați un defect în perioada de garanție, contactați-ne prin orice metodă convenabilă. Analizarea solicitării durează până la 10 zile lucrătoare din momentul primirii produsului și a tuturor informațiilor necesare.",
          ],
          ...
          decisionNote: "Dacă defectul de fabricație se confirmă, cumpărătorului i se rambursează suma integrală sau produsul este înlocuit. Dacă defectul nu se confirmă, produsul se returnează fără reparație, iar cheltuielile pentru expertiză sunt suportate de cumpărător.",
          notCovered: "Garanția nu acoperă",
          notCoveredItems: [
            "Urme naturale de utilizare",
            "Zgârieturi fine, rosături și cute ale pielii",
            "Rupturi ale căptușelii în afara cusăturilor de fabrică",
            "Schimbarea culorii pielei întoarse din cauza umezelii",
            "Pierderea feroneriei demontabile fixate cu îmbinări pe șuruburi",
            "Colorarea produsului de la îmbrăcăminte sau alte materiale",
            "Uzură naturală în timpul folosirii",
          ],
          invalid: "Garanția nu se aplică în caz de",
          invalidItems: [
            "Încălcarea regulilor de utilizare și păstrare",
            "Deteriorări mecanice",
            "Expunere la substanțe chimice",
            "Reparații sau modificări independente",
            "Folosirea produsului în alt scop",
            "Depășirea sarcinii admisibile asupra produsului",
          ],
      ...
      : {
          ...
          warrantyText: [
            ...
            "The warranty period begins on the day the goods are handed over to the buyer.",
            "If you notice a defect during the warranty period, contact us in any convenient way. Review takes up to 10 business days from receipt of the item and all necessary information.",
          ],
          ...
          decisionNote: "If a manufacturing defect is confirmed, the buyer receives a full refund or replacement. If it is not confirmed, the item is returned without repair, and the cost of the expertise is paid by the buyer.",
          notCovered: "Warranty does not cover",
          notCoveredItems: [
            "Natural signs of use",
            "Minor scratches, scuffs and leather creases",
            "Lining tears outside factory seams",
            "Suede color changes caused by moisture",
            "Loss of removable hardware secured with screw fastenings",
            "Staining of the item from clothing or other materials",
            "Natural wear during use",
          ],
          invalid: "Warranty is void in case of",
          invalidItems: [
            "Violation of use and storage rules",
            "Mechanical damage",
            "Chemical exposure",
            "Independent repair or modification",
            "Use of the item for another purpose",
            "Exceeding the item's permitted load",
          ],
