...
function ShowcaseCard({ product }: { product: Product }) {
  ...
  return (
    <div className="group block min-w-0">
      ...
      <div className="relative mt-2.5 h-11 px-1">
