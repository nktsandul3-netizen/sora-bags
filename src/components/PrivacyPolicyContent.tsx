...
const localizedPrivacy = {
  ro: {
    ...
    sections: [
      ...
      { title: "3. Transferul datelor către terți", body: "Nu vindem și nu transmitem date personale către terți, cu excepția cazurilor:", items: ["Când este necesar pentru livrarea comenzii;", "Când o cere legislația;", "Când utilizatorul și-a dat consimțământul."] },
  ...
  en: {
    ...
    sections: [
      ...
      { title: "3. Sharing data with third parties", body: "We do not sell or transfer personal data to third parties, except in the following cases:", items: ["When it is necessary for order delivery;", "When required by law;", "When the user has given consent."] },
