...
const copy = {
  ...
  ro: {
    ...
    returns: ["Certificatul nu poate fi schimbat în numerar.", "La returul unui produs plătit cu certificat, suma se returnează sub forma unui nou certificat cadou.", "Un certificat pierdut poate fi restabilit cu dovada cumpărării.", "Valabilitatea certificatului nu se prelungește."],
  ...
  en: {
    ...
    returns: ["The certificate cannot be exchanged for cash.", "If an item paid by certificate is returned, the amount is issued as a new gift certificate.", "A lost certificate can be restored with proof of purchase.", "The validity period cannot be extended."],
