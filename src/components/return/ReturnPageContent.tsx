...
const copy = {
  ...
  ro: {
    ...
    goodOptions: ["schimba produsul cu un alt model, altă culoare sau altă mărime, dacă este disponibil;", "alege alt produs, cu recalcularea diferenței de preț;", "primi rambursarea sumei achitate."],
    ...
    defectOptions: ["solicita înlocuirea cu un produs similar;", "schimba produsul cu alt model, cu recalcularea diferenței de preț;", "primi rambursarea integrală."],
  ...
  en: {
    ...
    goodConditions: ["the item has not been used;", "the item keeps its original appearance and properties;", "there is no damage or wear marks;", "original packaging, labels, tags and accessories are preserved."],
    goodCan: "When returning an item without defects, the buyer may:",
    goodOptions: ["exchange it for another model, color or size if available;", "choose another item, with any price difference recalculated;", "receive a refund."],
    ...
    defectOptions: ["request replacement with a similar item;", "exchange it for another model, with any price difference recalculated;", "receive a full refund."],
