...
const copy = {
  ru: {
    ...
    preorderTitle: "Товары по предзаказу",
    preorderText: "Некоторые модели доступны только по предзаказу. Срок доставки таких товаров составляет от 14 календарных дней.",
    statusText: "Статус товара указывается на странице каждого изделия:",
    available: "В наличии",
    preorderBadge: "Предзаказ (от 14 дней)",
  ...
  ro: {
    ...
    preorderTitle: "Produse disponibile pentru precomandă",
    preorderText: "Unele modele sunt disponibile doar pentru precomandă. Termenul de livrare începe de la 14 zile calendaristice.",
    statusText: "Statusul este indicat pe pagina fiecărui produs:",
    available: "În stoc",
    preorderBadge: "Precomandă (de la 14 zile)",
  ...
  en: {
    ...
    preorderText: "Some models are available only by pre-order. Delivery takes at least 14 calendar days.",
    statusText: "Product status is shown on each product page:",
    available: "In stock",
    preorderBadge: "Pre-order (14+ days)",
