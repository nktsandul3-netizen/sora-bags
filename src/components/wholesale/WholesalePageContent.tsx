...
const copy = {
  ...
  ro: {
    ...
    individual: ["Înțelegem că fiecare business are specificul său, de aceea putem propune condiții individuale, oferte speciale pentru clienții permanenți și suport în formarea sortimentului.", "Scopul nostru este să construim parteneriate pe termen lung, bazate pe încredere, calitatea produselor și servicii atente."],
    ...
    contacts: "Contacte",
    ctaNote: "Specialiștii noștri vor răspunde la întrebări și vă vor ajuta să alegeți condițiile potrivite pentru businessul dvs.",
  },
  en: {
    ...
    individual: ["Every business is different, so we can offer individual cooperation terms, special offers for regular clients and help building an effective assortment.", "Our goal is long-term, mutually beneficial partnerships built on trust, product quality and attentive service."],
